...
// GET completed items
todoItems.MapGet("/status/{todostatus}", async (TodoDB db, Status todostatus) =>
    await db.Todos.Where(t => t.TodoStatus == todostatus).ToListAsync());
...
todoItems.MapPut("/{id}", async (int id, Todo inputTodo, TodoDB db) =>
{
    ...
    todo.TodoStatus = inputTodo.TodoStatus;
